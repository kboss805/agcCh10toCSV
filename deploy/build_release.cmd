...
set PORTABLE_ROOT=%PORTABLE_STAGE%\agcCH10toCSV-v%VERSION%_portable
...
powershell -Command "Compress-Archive -Path '%PORTABLE_ROOT%' -DestinationPath '%PROJECT_DIR%\deploy\agcCH10toCSV-v%VERSION%_portable.zip' -Force"
...
echo  Portable ZIP:      %PROJECT_DIR%\deploy\agcCH10toCSV-v%VERSION%_portable.zip
echo  Installer EXE:     %PROJECT_DIR%\deploy\agcCH10toCSV-v%VERSION%_setup.exe
echo ============================================
